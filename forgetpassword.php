<html>
    ...
    <body>
        ...
        <h2 style="position: relative;left:488px;">Reset Your Password</h2>
        <p style="position: relative;left:430px;">Kindly check your email to reset your password </p>
        <form action="process.php" method="post" >
            <p>Email Id:</p><br/>
            <input type="email" placeholder="abc@xyz.com" name="email" required><br/><br/>
