...
;
  ...
  <option value="Physical haressment">Physical haressment</option>
                ...
                <div class ="group14">
                   ...
                   <p align="left"><strong>case cancelled:</strong> <input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="firinv[]" value="0"></p>
                    <p align="left"><strong>Investigation not start:</strong> <input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="firinv[]" value="1" checked></p>
                    <p align="left"><strong>under investigation:</strong><input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="firinv[]" value="2" ></p>
                    <p align="left"><strong>Proceded to magistrate:</strong><input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="firinv[]" value="3" ></p>
                </div> <div class ="group15">
                     <p ><strong>Magistrate status:</strong></p><br/>
                   <p align="left"><strong>chargesheet rejected</strong> <input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="mag[]" value="0"></p>
                   <p align="left"><strong>under investigation</strong> <input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="mag[]" value="1" checked></p>
                    <p align="left"><strong>proceded to trail</strong><input style="border-bottom:none;margin-bottom: 25px;font-family: Poppins" type="radio"  name="mag[]" value="2" ></p>
                </div> 
                 <div class ="group16">
