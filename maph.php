...
<html>
  <head>
    ...
    <script>
      ...
      // VARIABLES:
      var searchQuery = "Hospital"; // Used in service.textSearch()
//      var defaultLocation = {coords:{latitude:23.2599 , longitude:77.4126 }}; //Bhopal // Used when geolocation cannot acquire location even when user allowed location access.
  var defaultLocation = {coords:{latitude:22.7195687 , longitude:75.8577258}}; //Indore
  ...
  marker.setMap(map);
//          icon:'Map_pin_icon_green.svg2.png'
